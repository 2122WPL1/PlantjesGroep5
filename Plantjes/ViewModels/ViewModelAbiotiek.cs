...
namespace Plantjes.ViewModels
{
    public class ViewModelAbiotiek : ViewModelBase
    {
        ...
        private void FillBasedOnPlant(Plant? plant)
        {
            ...
            {
                foreach (Control c in AbioControlsBezonning)
                {
                ...
                foreach (Control c in AbioControlsVochtbehoefte)
                {
                ...
                foreach (Control c in AbioControlsVoedingsbehoefte)
                {
                ...
                foreach (Control c in AbioControlsGrondsoort)
                {
                ...
                foreach (Control c in AbioControlsReactieAntagonischeOmg)
                {
            ...
            {
                foreach (Control c in AbioControlsHabitat)
                {
